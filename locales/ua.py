TEXTS = {
    ...
    "booking_details": (
        ...
        "Дата: {date}\n"
        "Час: {time}\n"
        "Сума завдатку: {deposit}€"
    ),
    "deposit": (
        "💳 Для підтвердження запису внесіть завдаток.\n\n"
    ...
    "waiting_confirmation": (
        ...
        "Після перевірки завдатку ви отримаєте повідомлення з підтвердженням."
    ),
    "master_new_booking": (
        "Новий запис 💅\n\n"
        "Клієнт: {client_name}\n"
